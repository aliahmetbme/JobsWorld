...
import { useWindowDimensions, View, Platform, Text, TouchableOpacity, Image, Dimensions, SafeAreaView } from 'react-native';
  ...
  return (
    <NavigationContainer>
      <Drawer.Navigator
        ...
        screenOptions={{
          headerTitle:" ",
          headerStatusBarHeight:Platform.OS === "ios" ? 35: null,
